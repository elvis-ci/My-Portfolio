...
.form-title {
  ...
  font-size: 1.75rem;
  color: var(--btn-bg);
  margin-bottom: 1rem; /* give spacing under heading */
}
...
.contact-icons {
  padding-right: 1rem;
  margin-right: 1rem;
  border-right: 2px dashed var(--box-shadow);
  position: relative;
}
.contact-icons::after {
  content: "";
  ...
  height: 100%;
  border-right: 1px dashed var(--btn-bg); /* dashed line */
