...
<template>
  <main id="main-content" class="resume-section blog-div">
    <div class="px-4">
      <div class="container">
        ...
        <section class="section-header text-center">
          ...
          <p class="section-subtitle">
            ...
            Short reads and deep dives to help teams build better digital
            experiences.
          </p>
        </section>
        ...
        <div class="row g-4">
          ...
          <section class="col-lg-9" aria-labelledby="blog-articles-heading">
            <h2 id="blog-articles-heading" class="visually-hidden">
              Blog Articles
            </h2>
            ...
            <nav aria-label="Blog pagination" class="mt-4 mx-auto">
              <ul class="pagination justify-content-center mb-0">
                <li class="page-item disabled">
                  <button class="page-link">&lsaquo; Prev</button>
                </li>
                ...
                <li class="page-item">
                  <button class="page-link">Next &rsaquo;</button>
                </li>
              </ul>
            </nav>
          </section>
          ...
          <aside class="col-lg-3" aria-label="Blog sidebar">
            <div
              class="sidebar-card p-3 mb-4"
              aria-labelledby="categories-heading"
            >
              <h3 id="categories-heading" class="sub-section-title">
                Categories
              </h3>
...
/* tag badge */
.tag-badge {
  background: rgba(139, 255, 151, 0.181);
  border: 1px solid var(--color-border);
